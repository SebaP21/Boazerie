...
/** The &quot;About&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type About = About_Fields & AcfFieldGroup & AcfFieldGroupFields & {
  __typename?: 'About';
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;About&quot; Field Group */
  aboutDescription1?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;About&quot; Field Group */
  aboutDescription2?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;About&quot; Field Group */
  aboutHeader?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;About&quot; Field Group */
  aboutPicture?: Maybe<AcfMediaItemConnectionEdge>;
  /**
...
/** Interface representing fields of the ACF &quot;About&quot; Field Group */
export type About_Fields = {
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;About&quot; Field Group */
  aboutDescription1?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;About&quot; Field Group */
  aboutDescription2?: Maybe<Scalars['String']['output']>;
...
export type ContactForm = AcfFieldGroup & AcfFieldGroupFields & ContactForm_Fields & {
  ...
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;ContactForm&quot; Field Group */
  adres?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;email&quot; Field Type added to the schema as part of the &quot;ContactForm&quot; Field Group */
  eMail?: Maybe<Scalars['String']['output']>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
...
/** Input for the createFaqBox mutation. */
export type CreateFaqBoxInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the createFaqBox mutation. */
export type CreateFaqBoxPayload = {
  __typename?: 'CreateFaqBoxPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
...
/** Input for the createONas mutation. */
export type CreateONasInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the createONas mutation. */
export type CreateONasPayload = {
  __typename?: 'CreateONasPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  oNas?: Maybe<ONas>;
...
/** Input for the deleteFaqBox mutation. */
export type DeleteFaqBoxInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the FaqBox to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteFaqBox mutation. */
export type DeleteFaqBoxPayload = {
  __typename?: 'DeleteFaqBoxPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
/** Input for the deleteONas mutation. */
export type DeleteONasInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the ONas to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteONas mutation. */
export type DeleteONasPayload = {
  __typename?: 'DeleteONasPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
/** The FaqBox type */
export type FaqBox = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'FaqBox';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<FaqBoxToFaqBoxConnection>;
  /** Returns all blocks as a JSON object */
  blocks?: Maybe<Scalars['JSON']['output']>;
   ...
   */
  parent?: Maybe<FaqBoxToParentConnectionEdge>;
  /** The password for the faq object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the FaqBox type and the FaqBox type */
  preview?: Maybe<FaqBoxToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The FaqBox type */
export type FaqBoxAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The FaqBox type */
export type FaqBoxContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The FaqBox type */
export type FaqBoxEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The FaqBox type */
export type FaqBoxEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The FaqBox type */
export type FaqBoxTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to FaqBox Nodes */
export type FaqBoxConnection = {
  /** A list of edges (relational context) between RootQuery and connected FaqBox Nodes */
  edges: Array<FaqBoxConnectionEdge>;
  /** A list of connected FaqBox Nodes */
  nodes: Array<FaqBox>;
  /** Information about pagination in a connection. */
  pageInfo: FaqBoxConnectionPageInfo;
};

/** Edge between a Node and a connected FaqBox */
export type FaqBoxConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected FaqBox Node */
  node: FaqBox;
};

/** Page Info on the connected FaqBoxConnectionEdge */
export type FaqBoxConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the FaqBox type and the FaqBox type */
export type FaqBoxToFaqBoxConnection = Connection & FaqBoxConnection & {
  __typename?: 'FaqBoxToFaqBoxConnection';
  /** Edges for the FaqBoxToFaqBoxConnection connection */
  edges: Array<FaqBoxToFaqBoxConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<FaqBox>;
  /** Information about pagination in a connection. */
  pageInfo: FaqBoxToFaqBoxConnectionPageInfo;
};

/** An edge in a connection */
export type FaqBoxToFaqBoxConnectionEdge = Edge & FaqBoxConnectionEdge & {
  __typename?: 'FaqBoxToFaqBoxConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;FaqBoxToFaqBoxConnection&quot; */
export type FaqBoxToFaqBoxConnectionPageInfo = FaqBoxConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'FaqBoxToFaqBoxConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the FaqBox type and the FaqBox type */
export type FaqBoxToParentConnectionEdge = Edge & FaqBoxConnectionEdge & OneToOneConnection & {
  __typename?: 'FaqBoxToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the FaqBox type and the FaqBox type */
export type FaqBoxToPreviewConnectionEdge = Edge & FaqBoxConnectionEdge & OneToOneConnection & {
  __typename?: 'FaqBoxToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: FaqBox;
...
/** The Galeria type */
export type Galeria = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfProductDescription & {
  __typename?: 'Galeria';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the portfolio-gallery object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the portfolio-gallery object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
  ...
  /** The password for the portfolio-gallery object. */
  password?: Maybe<Scalars['String']['output']>;
  ...
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
  /** Fields of the ProductDescription ACF Field Group */
...
/** Edge between a Node and a connected Galeria */
...
/** Page Info on the connected GaleriaConnectionEdge */
...
/** Page Info on the &quot;GaleriaToGaleriaConnection&quot; */
...
/** The Logo type */
export type Logo = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfLogoImage & {
  __typename?: 'Logo';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
  ...
  /** Fields of the LogoImage ACF Field Group */
  logoImage?: Maybe<LogoImage>;
  /** The local modified time for a post. If a post was recently updated the modified field will change to match the corresponding time. */
  modified?: Maybe<Scalars['String']['output']>;
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
...
/** The &quot;LogoImage&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type LogoImage = AcfFieldGroup & AcfFieldGroupFields & LogoImage_Fields & {
   ...
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;LogoImage&quot; Field Group */
  logoImage?: Maybe<AcfMediaItemConnectionEdge>;
};

/** Interface representing fields of the ACF &quot;LogoImage&quot; Field Group */
export type LogoImage_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
export type MenuItemObjectUnion = Category | FaqBox | Galeria | Logo | ONas | Offer | Page | Post | Tag;
...
/** The ONas type */
export type ONas = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfAbout & {
  __typename?: 'ONas';
  /** Fields of the About ACF Field Group */
  about?: Maybe<About>;
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<ONasToONasConnection>;
  /** Returns all blocks as a JSON object */
  blocks?: Maybe<Scalars['JSON']['output']>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the o_nas object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the o_nas object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  oNasId: Scalars['Int']['output'];
  /**
   * The parent of the content node.
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<ONasToParentConnectionEdge>;
  /** The password for the o_nas object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the ONas type and the ONas type */
  preview?: Maybe<ONasToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The ONas type */
export type ONasContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The ONas type */
export type ONasEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The ONas type */
export type ONasEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The ONas type */
export type ONasTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to ONas Nodes */
export type ONasConnection = {
  /** A list of edges (relational context) between RootQuery and connected ONas Nodes */
  edges: Array<ONasConnectionEdge>;
  /** A list of connected ONas Nodes */
  nodes: Array<ONas>;
  /** Information about pagination in a connection. */
  pageInfo: ONasConnectionPageInfo;
};

/** Edge between a Node and a connected ONas */
export type ONasConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected ONas Node */
  node: ONas;
};

/** Page Info on the connected ONasConnectionEdge */
export type ONasConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the ONas type and the ONas type */
export type ONasToONasConnection = Connection & ONasConnection & {
  __typename?: 'ONasToONasConnection';
  /** Edges for the ONasToONasConnection connection */
  edges: Array<ONasToONasConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ONas>;
  /** Information about pagination in a connection. */
  pageInfo: ONasToONasConnectionPageInfo;
};

/** An edge in a connection */
export type ONasToONasConnectionEdge = Edge & ONasConnectionEdge & {
  __typename?: 'ONasToONasConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;ONasToONasConnection&quot; */
export type ONasToONasConnectionPageInfo = ONasConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'ONasToONasConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the ONas type and the ONas type */
export type ONasToParentConnectionEdge = Edge & ONasConnectionEdge & OneToOneConnection & {
  __typename?: 'ONasToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the ONas type and the ONas type */
export type ONasToPreviewConnectionEdge = Edge & ONasConnectionEdge & OneToOneConnection & {
  __typename?: 'ONasToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: ONas;
...
/** The Offer type */
export type Offer = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfOfferCard & {
  __typename?: 'Offer';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
  /** Fields of the OfferCard ACF Field Group */
  offerCard?: Maybe<OfferCard>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
...
/** The &quot;OfferCard&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type OfferCard = AcfFieldGroup & AcfFieldGroupFields & OfferCard_Fields & {
   ...
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;OfferCard&quot; Field Group */
  offerDescription?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;OfferCard&quot; Field Group */
  offerPicture?: Maybe<AcfMediaItemConnectionEdge>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;OfferCard&quot; Field Group */
  offerTitle?: Maybe<Scalars['String']['output']>;
};

/** Interface representing fields of the ACF &quot;OfferCard&quot; Field Group */
export type OfferCard_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** The page type */
export type Page = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfContactForm & WithAcfPageHeading & WithAcfPrivacyPolicyContent & {
  __typename?: 'Page';
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Connection between the NodeWithAuthor type and the User type */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
  /** Fields of the PageHeading ACF Field Group */
  ...
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
  /** Fields of the PrivacyPolicyContent ACF Field Group */
  privacyPolicyContent?: Maybe<PrivacyPolicyContent>;
  /** If the current node is a revision, this field exposes the node this is a revision of. Returns null if the node is not a revision of another node. */
  revisionOf?: Maybe<NodeWithRevisionsToContentNodeConnectionEdge>;
  /** Connection between the Page type and the page type */
...
/** The &quot;PageHeading&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageHeading = AcfFieldGroup & AcfFieldGroupFields & PageHeading_Fields & {
   ...
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;PageHeading&quot; Field Group */
  headerImageSrc?: Maybe<AcfMediaItemConnectionEdge>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageHeading&quot; Field Group */
  pageHeader?: Maybe<Scalars['String']['output']>;
};

/** Interface representing fields of the ACF &quot;PageHeading&quot; Field Group */
export type PageHeading_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
export type PrivacyPolicyContent = AcfFieldGroup & AcfFieldGroupFields & PrivacyPolicyContent_Fields & {
   ...
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;textarea&quot; Field Type added to the schema as part of the &quot;PrivacyPolicyContent&quot; Field Group */
...
export type RootMutation = {
  ...
  /** The createFaqBox mutation */
  createFaqBox?: Maybe<CreateFaqBoxPayload>;
  ...
  /** The createONas mutation */
  createONas?: Maybe<CreateONasPayload>;
  ...
  /** The deleteFaqBox mutation */
  deleteFaqBox?: Maybe<DeleteFaqBoxPayload>;
  ...
  /** The deleteONas mutation */
  deleteONas?: Maybe<DeleteONasPayload>;
  ...
  /** The updateFaqBox mutation */
  updateFaqBox?: Maybe<UpdateFaqBoxPayload>;
  ...
  /** The updateONas mutation */
  updateONas?: Maybe<UpdateONasPayload>;
...
/** The root mutation */
export type RootMutationCreateFaqBoxArgs = {
  input: CreateFaqBoxInput;
};
...
/** The root mutation */
export type RootMutationCreateONasArgs = {
  input: CreateONasInput;
};
...
/** The root mutation */
export type RootMutationDeleteFaqBoxArgs = {
  input: DeleteFaqBoxInput;
};
...
/** The root mutation */
export type RootMutationDeleteONasArgs = {
  input: DeleteONasInput;
};
...
/** The root mutation */
export type RootMutationUpdateFaqBoxArgs = {
  input: UpdateFaqBoxInput;
};
...
/** The root mutation */
export type RootMutationUpdateONasArgs = {
  input: UpdateONasInput;
};
...
export type RootQuery = {
  ...
  /** Connection between the RootQuery type and the FaqBox type */
  allFaqBox?: Maybe<RootQueryToFaqBoxConnection>;
  /** Connection between the RootQuery type and the Galeria type */
  allGaleria?: Maybe<RootQueryToGaleriaConnection>;
  /** Connection between the RootQuery type and the Logo type */
  allLogo?: Maybe<RootQueryToLogoConnection>;
  /** Connection between the RootQuery type and the ONas type */
  allONas?: Maybe<RootQueryToONasConnection>;
  /** Connection between the RootQuery type and the Offer type */
  allOffer?: Maybe<RootQueryToOfferConnection>;
  ...
  /** An object of the FaqBox Type.  */
  faqBox?: Maybe<FaqBox>;
  /**
   * A FaqBox object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  faqBoxBy?: Maybe<FaqBox>;
...
/** The root entry point into the Graph */
export type RootQueryAllFaqBoxArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToFaqBoxConnectionWhereArgs>;
};


/** The root entry point into the Graph */
export type RootQueryAllGaleriaArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The root entry point into the Graph */
export type RootQueryAllONasArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToONasConnectionWhereArgs>;
};


/** The root entry point into the Graph */
export type RootQueryAllOfferArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The root entry point into the Graph */
export type RootQueryFaqBoxArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<FaqBoxIdType>;
};


/** The root entry point into the Graph */
export type RootQueryFaqBoxByArgs = {
  faqBoxId?: InputMaybe<Scalars['Int']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
...
/** The root entry point into the Graph */
export type RootQueryONasArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<ONasIdType>;
};


/** The root entry point into the Graph */
export type RootQueryONasByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  oNasId?: InputMaybe<Scalars['Int']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};
...
/** Connection between the RootQuery type and the FaqBox type */
export type RootQueryToFaqBoxConnection = Connection & FaqBoxConnection & {
  __typename?: 'RootQueryToFaqBoxConnection';
  /** Edges for the RootQueryToFaqBoxConnection connection */
  edges: Array<RootQueryToFaqBoxConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<FaqBox>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToFaqBoxConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToFaqBoxConnectionEdge = Edge & FaqBoxConnectionEdge & {
  __typename?: 'RootQueryToFaqBoxConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: FaqBox;
...
/** Page Info on the &quot;RootQueryToFaqBoxConnection&quot; */
export type RootQueryToFaqBoxConnectionPageInfo = FaqBoxConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToFaqBoxConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToFaqBoxConnection connection */
export type RootQueryToFaqBoxConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Page Info on the &quot;RootQueryToGaleriaConnection&quot; */
...
/** Connection between the RootQuery type and the ONas type */
export type RootQueryToONasConnection = Connection & ONasConnection & {
  __typename?: 'RootQueryToONasConnection';
  /** Edges for the RootQueryToONasConnection connection */
  edges: Array<RootQueryToONasConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ONas>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToONasConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToONasConnectionEdge = Edge & ONasConnectionEdge & {
  __typename?: 'RootQueryToONasConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: ONas;
...
/** Page Info on the &quot;RootQueryToONasConnection&quot; */
export type RootQueryToONasConnectionPageInfo = ONasConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToONasConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToONasConnection connection */
export type RootQueryToONasConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Input for the updateFaqBox mutation. */
export type UpdateFaqBoxInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the updateFaqBox mutation. */
export type UpdateFaqBoxPayload = {
  __typename?: 'UpdateFaqBoxPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  faqBox?: Maybe<FaqBox>;
...
/** Input for the updateONas mutation. */
export type UpdateONasInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the updateONas mutation. */
export type UpdateONasPayload = {
  __typename?: 'UpdateONasPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  oNas?: Maybe<ONas>;
...
/** Provides access to fields of the &quot;About&quot; ACF Field Group via the &quot;about&quot; field */
export type WithAcfAbout = {
  /** Fields of the About ACF Field Group */
  about?: Maybe<About>;
};
...
/** Provides access to fields of the &quot;LogoImage&quot; ACF Field Group via the &quot;logoImage&quot; field */
export type WithAcfLogoImage = {
  /** Fields of the LogoImage ACF Field Group */
  logoImage?: Maybe<LogoImage>;
};

/** Provides access to fields of the &quot;OfferCard&quot; ACF Field Group via the &quot;offerCard&quot; field */
export type WithAcfOfferCard = {
  /** Fields of the OfferCard ACF Field Group */
  offerCard?: Maybe<OfferCard>;
};

/** Provides access to fields of the &quot;PageHeading&quot; ACF Field Group via the &quot;pageHeading&quot; field */
export type WithAcfPageHeading = {
  /** Fields of the PageHeading ACF Field Group */
  pageHeading?: Maybe<PageHeading>;
};

/** Provides access to fields of the &quot;PrivacyPolicyContent&quot; ACF Field Group via the &quot;privacyPolicyContent&quot; field */
export type WithAcfPrivacyPolicyContent = {
  /** Fields of the PrivacyPolicyContent ACF Field Group */
  privacyPolicyContent?: Maybe<PrivacyPolicyContent>;
};

/** Provides access to fields of the &quot;ProductDescription&quot; ACF Field Group via the &quot;productDescription&quot; field */
export type WithAcfProductDescription = {
  /** Fields of the ProductDescription ACF Field Group */
  productDescription?: Maybe<ProductDescription>;
};
...
export type FaqContentQuery = { __typename?: 'RootQuery', allFaqBox?: { __typename?: 'RootQueryToFaqBoxConnection', nodes: Array<{ __typename?: 'FaqBox', content?: string | null, title?: string | null }> } | null };
...
export function useAboutContentSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AboutContentQuery, AboutContentQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
...
/**
 * __useFaqContentQuery__
 *
 * To run a query within a React component, call `useFaqContentQuery` and pass it any options that fit your needs.
 * When your component renders, `useFaqContentQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFaqContentQuery({
 *   variables: {
 *   },
 * });
 */
export function useFaqContentQuery(baseOptions?: Apollo.QueryHookOptions<FaqContentQuery, FaqContentQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FaqContentQuery, FaqContentQueryVariables>(FaqContentDocument, options);
      }
export function useFaqContentLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FaqContentQuery, FaqContentQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FaqContentQuery, FaqContentQueryVariables>(FaqContentDocument, options);
        }
export function useFaqContentSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FaqContentQuery, FaqContentQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FaqContentQuery, FaqContentQueryVariables>(FaqContentDocument, options);
        }
export type FaqContentQueryHookResult = ReturnType<typeof useFaqContentQuery>;
export type FaqContentLazyQueryHookResult = ReturnType<typeof useFaqContentLazyQuery>;
export type FaqContentSuspenseQueryHookResult = ReturnType<typeof useFaqContentSuspenseQuery>;
export type FaqContentQueryResult = Apollo.QueryResult<FaqContentQuery, FaqContentQueryVariables>;
...
export function useLogoContentSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<LogoContentQuery, LogoContentQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
